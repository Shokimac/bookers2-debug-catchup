...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/books/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function($) {var i,
    tmp,
    countData = new Array();

for (i = 0; i < 6; i++) {
  tmp = $('input[name="' + i + '_ago"]').val();
  countData.push(tmp);
}

alert(countData); //折れ線グラフ
...
/******/ });
//# sourceMappingURL=index-42a21154ee18d145c5a3.js.map